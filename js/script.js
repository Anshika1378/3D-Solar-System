...
function createMaterialArray() {
  const skyboxImagepaths = ['../media/Sky/space_ft.png', '../media/Sky/space_bk.png', '../media/Sky/space_up.png', '../media/Sky/space_dn.png', '../media/Sky/space_rt.png', '../media/Sky/space_lf.png']
...
function init() {
  ...
  setSkyBox();
  planet_earth = loadPlanetTexture("../media/earth_hd.jpg", 4, 100, 100, 'standard');
  planet_sun = loadPlanetTexture("../media/sun_hd.jpg", 20, 100, 100, 'basic');
  planet_mercury = loadPlanetTexture("../media/mercury_hd.jpg", 2, 100, 100, 'standard');
  planet_venus = loadPlanetTexture("../media/venus_hd.jpg", 3, 100, 100, 'standard');
  planet_mars = loadPlanetTexture("../media/mars_hd.jpg", 3.5, 100, 100, 'standard');
  planet_jupiter = loadPlanetTexture("../media/jupiter_hd.jpg", 10, 100, 100, 'standard');
  planet_saturn = loadPlanetTexture("../media/saturn_hd.jpg", 8, 100, 100, 'standard');
  planet_uranus = loadPlanetTexture("../media/uranus_hd.jpg", 6, 100, 100, 'standard');
  planet_neptune = loadPlanetTexture("../media/neptune_hd.jpg", 5, 100, 100, 'standard');
